public class J_196BooleanParenthesization {
    ...
    public static void main(String[] args) {
        String s = "T|T&F^T";
        System.out.println(" number of ways we can parenthesize the expression so that the value of expression evaluates to true is "+countWays(s));
    }
}
